...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $role = Role::create(['name' => 'Técnico'])->givePermissionTo(['trabajos_create', 'trabajos_edit', 'trabajos_show', 'trabajos_delete', 'trabajos_access', 'comentarios_create', 'comentarios_edit', 'comentarios_show', 'comentarios_delete', 'comentarios_access', 'informes_create', 'informes_edit', 'informes_show', 'informes_delete', 'informes_access', 'viaticos_create', 'viaticos_edit', 'viaticos_show', 'viaticos_delete', 'viaticos_access', 'boletas_create', 'boletas_edit', 'boletas_show', 'boletas_delete', 'boletas_access']);
