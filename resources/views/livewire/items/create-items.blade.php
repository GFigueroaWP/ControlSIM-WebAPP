        ...
        <form wire:submit.prevent='submitItem' class="space-y-4">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <x-jet-input id="it_nombre" wire:model.lazy='it_nombre' type="text" placeholder="Producto/Servicio" class="mt-1 block w-full"/>
                    <x-jet-input-error for="it_nombre" class="mt-2" />
                </div>
                <div>
                    <x-jet-label for="it_valor" value="{{ __('Precio') }}" />
                    <x-jet-input id="it_valor" wire:model='it_valor' type="text" placeholder='10000' class="mt-1 block w-full"/>
