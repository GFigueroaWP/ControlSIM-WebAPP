        ...
        <form wire:submit.prevent='submit' class="space-y-4">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <x-jet-input id="con_nombre" wire:model.lazy='con_nombre' type="text" placeholder='Contacto ejemplo'
                        class="mt-1 block w-full" />
                    <x-jet-input-error for="con_nombre" class="mt-2" />
                </div>
                <div>
                    <x-jet-label for="con_email" value="{{ __('Email') }}" />
                    <x-jet-input id="con_email" wire:model.lazy='con_email' type="email" placeholder='contacto@email.cl'
                        class="mt-1 block w-full" />
                    <x-jet-input-error for="cli_email" class="mt-2" />
                </div>
                <div>
                    <x-jet-label for="con_telefono" value="{{ __('Telefono') }}" />
                    <x-jet-input id="con_telefono" wire:model.lazy='con_telefono' type="text" placeholder='912344678'
                        class="mt-1 block w-full" />
